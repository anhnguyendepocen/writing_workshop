...
\item
  \textbf{How to get words on paper.} Our focus will be strongly on improving and
...
The examples in \emph{Style} are mainly from academic non-fiction, although not
...
In the introduction of this ebook, I've included links to three papers that
we'll use as examples, in addition to working with your own manuscripts. Read
these three papers and rank them (1 as best to 3 as worst) in terms of: (1) how
easy you found it to read; (2) how much you enjoyed reading it; (3) how much you
...
\emph{Writing Science} thoughtfully discusses what an Introduction needs to do in a
...
In 2--3 sentences, \emph{describe} what your manuscript covers.

In 2--3 more sentences, \emph{explain} why your manuscript is important in advancing
...
\newthought{For a few years now, you}
